...
import facebookAuthRoute from './routes/facebookAuth';
import facebookAuthCallback from './routes/facebookAuthCallBack';
...
app.use('/auth/facebook/callback',facebookAuthCallback)
